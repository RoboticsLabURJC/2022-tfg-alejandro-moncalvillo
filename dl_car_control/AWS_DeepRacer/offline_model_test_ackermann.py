...
def parse_args():
    ...
    parser.add_argument("--test_dir", type=str, action = "append", default= [], help="Directory to find Test Data")
    parser.add_argument("--net_name", type=str, default=None, help="name of the neural network file")
...
def main():
    ...
    for dataset in args.test_dir:
        data_file = open(path + "/" + dataset + "/data.csv", "r")
        ...
        for line in reader_csv:
            ...
            image = cv2.imread(path + "/" + dataset + "/" + line[0])
